...
public class FragmentData extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(appcamp.hemangkumar.viewpagerfragment.R.layout.fragment_fragment_data, container, false);
        TextView tv = (TextView) v.findViewById(appcamp.hemangkumar.viewpagerfragment.R.id.textView);
        tv.setText("Fragment Baby!");
        return v;
    }
